    ...
    <div class="Card">
      <section class="layout">
          ...
          <div class="row" style="gap: 5px;">
            ...
            <div class="col div-buttom"
              ...
              <div class="btn-group2">
                ...
                <InEntrega v-if="RegIn" :numV="RegIn.numero_vuelo" :fechaM="RegIn.fecha_manifiesto" :piezas="RegIn.piezas_entrega" :peso="RegIn.peso"
                  :numEm="RegIn.no_embarque" :destinatario="RegIn.destinatario" :liquidaA="RegIn.liquida_aduana"/>
        ...
        <UpComplemento v-if="btnCoUp" :fecha="fecha" :operador="operador" :numero_vuelo="numero_vuelo"
          :btnCoUp="btnCoUp" @updateCoProps="updateCoPropsValue" />
...
import InEntrega from './pImpresion/InEntrega.vue';
