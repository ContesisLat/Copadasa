    ...
    <div class="ReportPage">
        ...
        <form class="row g-3 needs-validation" novalidate>
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="validationCustom01" v-model="almacen" disabled>
...
let tipo_almacen = ref(props.tipo_almacen)
...
const handleSubmit = async () => {
    try {
        const response = await axios.post(dUrl.urlGlobal +'/api2/update/', {
            table: 'logalma', 
            filters: { almacen: almacen.value }, // Filtro para identificar el registro a actualizar
            data: { descripcion: descripcion.value, tipo_almacen: tipo_almacen.value, status: status.value } // Datos a actualizar
        })
