class CopadasaRouter(object):
    ...
    def db_for_read(self, model, **hints):
        ...
        """
        if model._meta.app_label == 'copadasa':
            return 'copadasa_db'
        return None
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        """
        if obj1._meta.app_label == 'copadasa' or \
           obj2._meta.app_label == 'copadasa':
           return True
        return None
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        database.
        """
        if app_label == 'copadasa':
            return db == 'copadasa_db'
        return None